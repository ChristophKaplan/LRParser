...
List<ProductionRule> P = new()
{
    ...
    new ProductionRule(new NonTerminal("cond"), new Terminal("if"),new NonTerminal("boolexpr"),new Terminal("then"),new NonTerminal("stmt"),new Terminal("fi")),
...
Console.WriteLine(cnf.FIRST(new NonTerminal("stmt")).Aggregate("FIRST ():",(c,n)=>$"{c} {n},"));